...
import 'package:food_in_flutter/SuccessPage.dart';
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 15,),
                    Text("Comida japonesa elaborada con pescado crudo y una variedad de ingredientes y condimentos.",
                      style: TextStyle(
                          color: Colors.white,
                          fontSize: 12
                      ),)
                ...
                child: Column(
                  children: [
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.end,
                      children: [
                        Text("Su Carrito de compra", style: TextStyle(
                            fontSize: 22,
                            fontWeight: FontWeight.w700
                        ),),
                        SizedBox(width: 10,),
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text("Total (3 platillos)", style: TextStyle(
                            fontWeight: FontWeight.w700,
                            fontSize: 18
                        ),),
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text("+gastos de envío", style: TextStyle(
                            fontWeight: FontWeight.w500,
                            fontSize: 16,
                            color: Colors.grey
                        ),),
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text("Descuentos", style: TextStyle(
                            fontWeight: FontWeight.w500,
                            fontSize: 16,
                            color: Colors.grey
                        ),),
                    ...
                    SizedBox(height: 25,),
                    Text("Tiene un codigo de descuento?", style: TextStyle(
                        color: blue
                    ),),
                    SizedBox(height: 20,),
                    InkWell(
